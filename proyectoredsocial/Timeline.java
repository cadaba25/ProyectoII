...
private static Users u=new Users();
    ...
    public Timeline() {
        ...
        String[] seguidos= Users.getSeguidosDeUsuarioLogueado();
        String user=Users.getUsuariologgeado();
        u.setGenero(user);
        String[] todoslostweets = Tweets.obtenerTweetsFiltrados(seguidos, user);
        feed.setListData(todoslostweets);
        foto();
    }
    ...
    private void initComponents() {
        ...
        espaciotweet = new javax.swing.JTextField();
        timeline = new javax.swing.JScrollPane();
        ...
        jLabel2.setText("Bienvenido: "+Users.getUsuariologgeado()+"\n Twittea algo:");

        timeline.setViewportView(feed);
        ...
        jButton3.setText("Buscar Personas");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fotos/logo.png"))); // NOI18N
        jLabel3.setText("jLabel3");

        jButton5.setBackground(new java.awt.Color(0, 0, 0));
        jButton5.setForeground(new java.awt.Color(255, 255, 255));
        jButton5.setText("Buscar Hashtags");
        ...
        jButton6.setText("Ver Menciones");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(26, 26, 26)
                        .addComponent(fotoperfil, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(espaciotweet, javax.swing.GroupLayout.PREFERRED_SIZE, 389, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(14, 14, 14)
                                .addComponent(jButton1))
                            .addComponent(timeline, javax.swing.GroupLayout.PREFERRED_SIZE, 451, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(espaciotweet, javax.swing.GroupLayout.DEFAULT_SIZE, 44, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(timeline, javax.swing.GroupLayout.DEFAULT_SIZE, 355, Short.MAX_VALUE)
                        .addGap(10, 10, 10))))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(15, 15, 15)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String tweet=espaciotweet.getText();
        if(tweet.length()>=140){
            JOptionPane.showMessageDialog(null, "No se pueden escribir mas de 140 caracteres");
        }else{
        String username=Users.getUsuariologgeado();
        Date fecha=new Date();       
        if(t.publicar(username, tweet, fecha)==true){
            System.out.println("Se publico el tweet");
            espaciotweet.setText("");
            String[] seguidos= Users.getSeguidosDeUsuarioLogueado();
            String[] tweetsseguidos = Tweets.obtenerTweetsFiltrados(seguidos,username);
            feed.setListData(tweetsseguidos);
        }
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        u.setNombreVisita(username);
        u.setUsernameVisita(username);
        u.setSeguidores(username);
        u.setSeguidos(username);
    ...
    private javax.swing.JTextField espaciotweet;
    ...
    private javax.swing.JScrollPane timeline;
